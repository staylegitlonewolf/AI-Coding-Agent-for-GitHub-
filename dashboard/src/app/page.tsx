        ...
        {!session ? (
           <div className="flex flex-col items-center justify-center pt-16 text-center">
              ...
              <h2 className="text-4xl md:text-5xl font-extrabold tracking-tighter mb-4 text-transparent bg-clip-text bg-linear-to-br from-white to-slate-400">
                Deploy AI Agents <br/> Securely & Remotely.
              </h2>
              <p className="text-slate-400 max-w-lg mb-8 text-md">
                1-Click Login via GitHub to visually select repositories and chat with the AI natively in your web browser.
              </p>
              <ButtonLogin />
           </div>
        ) : (
           <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                {repos.length === 0 && <p className="text-slate-500">No repositories found.</p>}
              </div>
           </div>
        )}
      </div>
